...
public class SecurityTester {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            testSqlInjection();
            testEnhancedSqlInjection();  // NEW: Enhanced SQL injection tests
            testTypeConfusion();
            testPathTraversal();
            ...
            // NEW: Additional vulnerability tests
            testJwtVulnerabilities();    // NEW: JWT token testing
            testBusinessLogic();         // NEW: Business logic testing
    ...
    /**
     * NEW: Enhanced SQL Injection Testing with Database Extraction
     */
    ...
    /**
     * NEW: Test JWT Token Vulnerabilities
     */
    ...
    /**
     * NEW: Test Business Logic Vulnerabilities
     */
